  ...
  export default {
    ...
    data() {
      return {
        ...
        ruleValidate: {
          NameOfstudent: [
            { required: true, message: "The NameOfstudent cannot be empty", trigger: "blur" }
          ],
          PwdOfstudent: [
            { required: true, message: "The PwdOfstudent cannot be empty", trigger: "blur" }
          ],
          ContactMethod: [
          ...
          ClassAndGrade: [
            { required: true, message: "The ClassAndGrade cannot be empty", trigger: "blur" }
          ],
          desc: [
